"""Autenticação por API Key para os endpoints da auditoria.

Autenticação simples de serviço a serviço: uma chave fixa, comparada
por igualdade, enviada num header configurável — sem sessão, sem
token com expiração, sem usuário real por trás da requisição.
"""
